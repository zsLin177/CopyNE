...
from wenet.transformer.multi_modal_model import init_mmner_model
...
def get_args():
    ...
    parser.add_argument('--pre_train_ctc', help='pre-trained ctc model', default=None)
...
def main():
    ...
    train_conf.update(configs['model_conf']['bert_conf'])
    ...
    configs['pre_train_ctc'] = args.pre_train_ctc
    configs['sp_weight'] = args.sp_weight
    
    # Init asr model from configs
    model = init_mmner_model(configs)
    print(model)
    ...
    # grouped_params = [
    #     {
    #         'params': [p for n, p in model.named_parameters() if 'fusion_layer' in n],
    #         'lr': configs['optim_conf']['lr'] * configs['fusion_layer_lr_times']
    #     },
    #     {
    #         'params': [p for n, p in model.named_parameters() if 'fusion_layer' not in n],
    ...
    grouped_params = [
        {
            'params': [p for n, p in model.named_parameters() if 'txt_model' in n],
            'lr': configs['optim_conf']['txt_model_lr']
        },
        {
            'params': [p for n, p in model.named_parameters() if 'sp_model' in n],
            'lr': configs['optim_conf']['sp_model_lr']
        },
        {
            'params': [p for n, p in model.named_parameters() if 'fusion_layer' in n],
            'lr': configs['optim_conf']['fusion_lr']
        },
        {
            'params': [p for n, p in model.named_parameters() if 'txt_model' not in n and 'sp_model' not in n and 'fusion_layer' not in n],
            'lr': configs['optim_conf']['decoder_lr']
        }
