...
def main():
    ...
    test_conf.update(copy.deepcopy(configs['model_conf']['bert_conf']))
    ...
    ctc_bos_eos_idx = configs['model_conf']['ctc_conf']['bos_eos_idx']
    txt_model_type = configs['model_conf']['txt_type']
    ...
    with torch.no_grad(), open(args.result_file+'asr', 'w') as fout:
        ...
        for batch_idx, batch in enumerate(test_data_loader):
            ...
            if args.mode == 'ctc_greedy_search':
                hyps, _ = model.encoder.sp_model.n_ctc_greedy_search(
                    encoder_out,
                    encoder_out_lens,
